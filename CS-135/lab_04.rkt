...
(define (intersect listA listB)
  (if (null? listA)
      '()
      (if (element? (car listA) listB)
          (cons (car listA) (intersect (cdr listA) listB))
          (intersect (cdr listA) listB))))

(define (intersection listA listB)
  (make-set(intersect listA listB)))
...
(define (helper listA listB)
  (if (null? listA)
      '()
      (if (element? (car listA) listB)
          (helper (cdr listA) listB)
          (cons (car listA) (helper (cdr listA) listB)))))

(define (set-difference listA listB)
  (make-set (helper listA listB)))
...
(define (sym-diff listA listB)
  (make-set (union (set-difference listA listB) (set-difference listB listA))))
